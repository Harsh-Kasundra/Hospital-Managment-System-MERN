...
const StaffAddPatient = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:8080/hms/staff/names", {
            method: "GET",
            headers: {
                Authorization: `Bearer ${localStorage.getItem("jsonwebtoken")}`,
                "Content-Type": "application/json",
    ...
    return (
        <div>
            <div className=" mx-2 my-3 staff-addemp-main">
                <div className="staff-addemp-heading px-2">
                    <div className="staff-addemp-title">Add Patient</div>
                </div>
                <div className="staff-addpatient-form">
                    <form className="form">
                        ...
                        <div className="row">
                            ...
                            <div className="col-6">
                                ...
                                <div className="d-flex justify-content-end">
                                    <div className="d-flex justify-content-end">
                                        <button
                                            className="staff-addemp-btn d-flex justify-content-center my-4"
