...
import "./StaffRegisteredPatient.css";
import Swal from "sweetalert2";

const StaffRegisteredPatients = () => {
                    ...
                    <td className="d-flex justify-content-evenly gap-2">
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                navigate(
                                    "/staff/registered_patients/" + patient._id
                                );
                            }}
                        >
                            <svg
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                navigate(
                                    "/staff/registered_patients/view/" +
                                        patient._id
                                );
                            }}
                        >
    ...
    return (
        <div className="mx-2 my-3 staff-employee-main">
            <div className="staff-employee-heading px-2">
                <div className="staff-employee-title">Registered Patient</div>
                <div className="staff-employee-addbtn">
                    <button
                        className="staff-employee-btn"
                        onClick={() => {
                            navigate("/staff/add_patient");
                        }}
                    >
            ...
            <div className="staff-patient-filter d-flex justify-content-between">
                ...
                <div className="staff-patient-docFilter">
                    <Select
                        isMulti
                        name="patient"
            ...
            <div className="staff-patient-display my-2 px-3 mt-4">
...
export default StaffRegisteredPatients;
