...
const EditPatient = () => {
    ...
    useEffect(() => {
        ...
        fetch(apiUrl + "/" + id, {
            ...
            .then((res) => {
                setData2(res); // Set patient data in state
            })
            .catch((err) => {
        ...
        fetch(apiUrl + "/" + id, {
            ...
            .then((res) => {
                if (res.ok) {
                    ...
                    navigate("/staff/registered_patients");
                } else {
            ...
            .catch((err) => {
                ...
                // Navigate to the login page in case of error
                navigate("/staffLogin");
                        ...
                        <div class="modal-body">
                            <div>
                                <div className=" mx-2 my-3 staff-addemp-main">
                                    <div className="staff-addemp-form">
                                        <form className="form">
                                            <div className="row">
                                                <div className="col-6">
                                                    <div className="mb-3">
